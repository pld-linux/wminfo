...
przechwytujący jego wynik i wyświetlający go jednorazowo w pięciu rzędach.
Możesz przewijać je do góry i na dół a także horyzontalnie. Przydatny
do wyświetlania logów i tym podobnych.
